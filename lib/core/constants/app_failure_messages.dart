abstract class AppFailureMessages {
  ...
  /// region - Conflict exceptions

  static const kConflictException = 'Conflict exception occurred.';

  /// endregion - Conflict exceptions

  /// region - Not Acceptable exceptions
  static const kNotAcceptable = 'Given input data is not acceptable or invalid';
}
