...
class VerifyOTPMobilePortraitWidget extends StatefulWidget {
  const VerifyOTPMobilePortraitWidget({super.key});

  @override
  State<VerifyOTPMobilePortraitWidget> createState() =>
      _VerifyOTPMobilePortraitWidgetState();
}

class _VerifyOTPMobilePortraitWidgetState
    extends State<VerifyOTPMobilePortraitWidget> {
            ...
            child: Column(
              ...
              children: [
                FittedBox(
                  fit: BoxFit.fill,
                  child: Text(
                    TextConstants.kVerificationCodeTitle,
